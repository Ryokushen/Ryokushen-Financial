...
function setupTransactionActions(appState) {
  ...
  tableContainer.addEventListener('click', async (e) => {
    ...
    if (e.target.classList.contains('edit')) {
      ...
      console.log('Edit clicked - transactionId:', transactionId)
      console.log('All transactions:', allTransactions)
      
      // Convert transactionId to match the type in allTransactions
      const transaction = allTransactions.find(t => String(t.id) === String(transactionId))

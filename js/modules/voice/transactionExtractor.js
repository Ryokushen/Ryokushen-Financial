  ...
  initializeCommonPatterns() {
    ...
    this.transactionPatterns = [
      ...
      },
      {
        ...
        pattern:
          /\b(?:spent|paid)\s+([^a-zA-Z]*(?:\d+|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred|thousand)\s*)+[^a-zA-Z]*)\s+(?:at|to|in)\s+([^f]+?)\s+for\s+(.+)/gi,
        extract: (match, text) => ({
          amount: match[1],
          merchant: match[2].trim(),
      ...
      },
      {
        ...
        pattern:
          /\b(?:bought|purchased)\s+(.+?)\s+for\s+([^a-zA-Z]*(?:\d+|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred|thousand)\s*)+[^a-zA-Z]*)\s+(?:at|from|in)\s+([^o]+?)(?:\s+on\s+(.+?))?$/gi,
        extract: (match, text) => ({
          amount: match[2],
      ...
      },
      {
        ...
        pattern:
          /\b([a-zA-Z\s]+?)\s+(?:at|from|in)\s+([a-zA-Z\s&]+?)\s+for\s+([^a-zA-Z]*(?:\d+|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred|thousand)\s*)+[^a-zA-Z]*)/gi,
        extract: (match, text) => ({
          amount: match[3],
          merchant: match[2].trim(),
          context: match[1].trim(),
      ...
      },
      {
        ...
        pattern:
          /\b(?:got\s+paid|received|earned)\s+([^a-zA-Z]*(?:\d+|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred|thousand)\s*)+[^a-zA-Z]*)/gi,
        extract: (match, text) => ({
          amount: match[1],
          merchant: null,
          context: 'income',
      ...
      },
      {
        ...
        pattern:
          /\b(?:paid\s+)?credit\s+card\s+(?:payment\s+)?([^a-zA-Z]*(?:\d+|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred|thousand)\s*)+[^a-zA-Z]*)/gi,
        extract: (match, text) => ({
          amount: match[1],
          merchant: null,
      ...
      },
      {
        ...
        pattern:
          /\b(?:gas|fuel|filled\s+up)\s+(?:for\s+)?([^a-zA-Z]*(?:\d+|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred|thousand)\s*)+[^a-zA-Z]*)/gi,
        extract: (match, text) => ({
          amount: match[1],
          merchant: null,
          context: 'gas',
